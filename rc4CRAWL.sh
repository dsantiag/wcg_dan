...
#PBS -o /gpfs/home/dsantiag/workingDir/masterLogFileC.log
#PBS -j oe 
#PBS -l mem=8gb
...
MASTERLOG="$BASEDIR/masterLogFileC.log" 

# file containing the list of packages to be processed
### REQUIRED ###
#SEEDFILE="$BASEDIR/packages.index"  
SEEDFILE="$BASEDIR/workingCRAWL.lst"


# generated on the fly
# used to keep track of progress
STATUS="$BASEDIR/statusC.log"        
touch $STATUS
...
PROCDIRA='/gpfs/group/olson/dsantiag/post_wcg2/AutoDock/procfaah/'
