...
#PBS -d /gpfs/home/dsantiag/workingDir/master_logs/procO/
#PBS -o /gpfs/home/dsantiag/workingDir/master_logs/procO/masterLogFileO.log
#PBS -j oe 
#PBS -l mem=16gb
...
MASTERLOG="$BASEDIR/master_logs/procO/masterLogFileO.log" 
#echo ">>>" `date` "START" >> $MASTERLOG
# file containing the list of packages to be processed
### REQUIRED ###
#SEEDFILE="$BASEDIR/packages.index"  
SEEDFILE="$BASEDIR/job_lists/workingOET1.lst"


# generated on the fly
# used to keep track of progress
STATUS="$BASEDIR/master_logs/statusO.log"        
touch $STATUS
...
/gpfs/home/dsantiag/local/MGLTools-1.5.7rc1/bin/pythonsh /gpfs/home/dsantiag/workingDir/bin/faah_vina_process_garibaldi00-O.py $PACKAGE
