...
#PBS -d /gpfs/home/dsantiag/workingDir/master_logs/crawlO/
#PBS -o /gpfs/home/dsantiag/workingDir/master_logs/crawlO/masterLogFileCO.log
#PBS -j oe 
#PBS -l mem=8gb
...
MASTERLOG="$BASEDIR/master_logs/crawlO/masterLogFileCO.log" 
#echo ">>>" `date` "START" >> $MASTERLOG
# file containing the list of packages to be processed
### REQUIRED ###
#SEEDFILE="$BASEDIR/packages.index"  
SEEDFILE="$BASEDIR/job_lists/workingCRAWLV.lst"


# generated on the fly
# used to keep track of progress
STATUS="$BASEDIR/master_logs/statusCV.log"        
touch $STATUS
...
echo PAKAGENAME: $PACKAGENAME
OUTDIR=/gpfs/group/olson/dsantiag/post_wcg2/crawl
PROCDIR=/gpfs/group/olson/dsantiag/post_wcg2/Vina/processed

#/home/rik/pkg/Python-2.7.8/python crawl_AD.py /mgl/storage/wcg/processed/ /mgl/storage/wcg/crawl/  --exptList "['Exp32','Exp37','Exp35']"

echo RUNNING: python /gpfs/home/dsantiag/bin/rik/crawl_ADV.py $PROCDIR $OUTDIR --exptList "['$PACKAGENAME']"
python /gpfs/home/dsantiag/workingDir/bin/crawl_ADO.py $PROCDIR $OUTDIR --exptList "['$PACKAGENAME']"
