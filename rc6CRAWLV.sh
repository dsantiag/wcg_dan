...
#PBS -o /gpfs/home/dsantiag/workingDir/masterLogFileCV.log
#PBS -j oe 
#PBS -l mem=8gb
...
python /gpfs/home/dsantiag/bin/rik/crawl_ADV.py $PROCDIR $OUTDIR --exptList "['$PACKAGENAME']"
